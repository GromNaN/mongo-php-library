 ...
 * @internal
 * @psalm-type DateFromPartsOperatorShape = array{year?: Decimal128|Int64|ResolvesToNumber|float|int|string, isoWeekYear?: Decimal128|Int64|ResolvesToNumber|float|int|string, month?: Decimal128|Int64|ResolvesToNumber|float|int|string, isoWeek?: Decimal128|Int64|ResolvesToNumber|float|int|string, day?: Decimal128|Int64|ResolvesToNumber|float|int|string, isoDayOfWeek?: Decimal128|Int64|ResolvesToNumber|float|int|string, hour?: Decimal128|Int64|ResolvesToNumber|float|int|string, minute?: Decimal128|Int64|ResolvesToNumber|float|int|string, second?: Decimal128|Int64|ResolvesToNumber|float|int|string, millisecond?: Decimal128|Int64|ResolvesToNumber|float|int|string, timezone?: ResolvesToString|string}|object{year?: Decimal128|Int64|ResolvesToNumber|float|int|string, isoWeekYear?: Decimal128|Int64|ResolvesToNumber|float|int|string, month?: Decimal128|Int64|ResolvesToNumber|float|int|string, isoWeek?: Decimal128|Int64|ResolvesToNumber|float|int|string, day?: Decimal128|Int64|ResolvesToNumber|float|int|string, isoDayOfWeek?: Decimal128|Int64|ResolvesToNumber|float|int|string, hour?: Decimal128|Int64|ResolvesToNumber|float|int|string, minute?: Decimal128|Int64|ResolvesToNumber|float|int|string, second?: Decimal128|Int64|ResolvesToNumber|float|int|string, millisecond?: Decimal128|Int64|ResolvesToNumber|float|int|string, timezone?: ResolvesToString|string}&stdClass|DateFromPartsOperator
 */
