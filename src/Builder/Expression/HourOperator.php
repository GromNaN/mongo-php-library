 ...
 * @internal
 * @psalm-type HourOperatorShape = array{date: DateTimeInterface|ObjectId|ResolvesToDate|ResolvesToObjectId|ResolvesToTimestamp|Timestamp|UTCDateTime|int|string, timezone?: ResolvesToString|string}|object{date: DateTimeInterface|ObjectId|ResolvesToDate|ResolvesToObjectId|ResolvesToTimestamp|Timestamp|UTCDateTime|int|string, timezone?: ResolvesToString|string}&stdClass|HourOperator
 */
