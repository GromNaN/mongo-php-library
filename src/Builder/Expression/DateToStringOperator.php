...
final class DateToStringOperator implements ResolvesToString, OperatorInterface
{
    ...
    /**
     * @var Optional|DateTimeInterface|ExpressionInterface|Type|array|bool|float|int|stdClass|string|null $onNull The value to return if the date is null or missing.
