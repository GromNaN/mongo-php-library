 ...
 * @internal
 * @psalm-type Atan2OperatorShape = list{Decimal128|Int64|ResolvesToNumber|float|int|string, Decimal128|Int64|ResolvesToNumber|float|int|string}|Atan2Operator
 */
