...
final class SinhOperator implements ResolvesToDouble, ResolvesToDecimal, OperatorInterface
{
    ...
    /**
     * @var Decimal128|Int64|ResolvesToNumber|float|int|string $expression $sinh takes any valid expression that resolves to a number, measured in radians. If the expression returns a value in degrees, use the $degreesToRadians operator to convert the value to radians.
