 ...
 * @internal
 * @psalm-type TanOperatorShape = Decimal128|Int64|ResolvesToNumber|float|int|string|TanOperator
 */
final class TanOperator implements ResolvesToDouble, ResolvesToDecimal, OperatorInterface
{
    ...
    /**
     * @var Decimal128|Int64|ResolvesToNumber|float|int|string $expression $tan takes any valid expression that resolves to a number. If the expression returns a value in degrees, use the $degreesToRadians operator to convert the result to radians.
