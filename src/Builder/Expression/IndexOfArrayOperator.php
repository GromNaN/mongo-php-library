...
final class IndexOfArrayOperator implements ResolvesToInt, OperatorInterface
{
    ...
    /** @var DateTimeInterface|ExpressionInterface|Type|array|bool|float|int|stdClass|string|null $search */
    public readonly DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|string|null $search;
