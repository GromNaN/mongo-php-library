 ...
 * @internal
 * @psalm-type MedianOperatorShape = array{input: BSONArray|Decimal128|Int64|PackedArray|ResolvesToNumber|array|float|int|string, method: string}|object{input: BSONArray|Decimal128|Int64|PackedArray|ResolvesToNumber|array|float|int|string, method: string}&stdClass|MedianOperator
 */
