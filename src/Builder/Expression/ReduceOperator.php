...
final class ReduceOperator implements ResolvesToAny, OperatorInterface
{
    ...
    /** @var DateTimeInterface|ExpressionInterface|Type|array|bool|float|int|stdClass|string|null $initialValue The initial cumulative value set before in is applied to the first element of the input array. */
    public readonly DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|string|null $initialValue;

    /**
     * @var DateTimeInterface|Document|ExpressionInterface|Serializable|Type|array|bool|float|int|stdClass|string|null $in A valid expression that $reduce applies to each element in the input array in left-to-right order. Wrap the input value with $reverseArray to yield the equivalent of applying the combining expression from right-to-left.
     ...
     */
    public readonly DateTimeInterface|Document|Serializable|Type|ExpressionInterface|stdClass|array|bool|float|int|string|null $in;
