 ...
 * @internal
 * @psalm-type AddOperatorShape = non-empty-list<DateTimeInterface|Decimal128|Int64|ResolvesToDate|ResolvesToNumber|UTCDateTime|float|int|string>|AddOperator
 */
