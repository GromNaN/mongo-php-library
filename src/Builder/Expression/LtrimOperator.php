 ...
 * @internal
 * @psalm-type LtrimOperatorShape = array{input: ResolvesToString|string, chars?: ResolvesToString|string}|object{input: ResolvesToString|string, chars?: ResolvesToString|string}&stdClass|LtrimOperator
 */
