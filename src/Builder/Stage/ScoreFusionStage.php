...
final class ScoreFusionStage implements StageInterface, OperatorInterface
{
    ...
    /** @var ScoreFusionInput|Document|Serializable|array|stdClass $input An object that specifies the pipelines to combine with score fusion. */
    ...
    /** @var Optional|ScoreFusionCombination|Document|Serializable|array|stdClass $combination An object that specifies how to combine the scores. */
    ...
    public function __construct(
        ...
        if (is_array($input)) {
            $input = new ScoreFusionInput(...$input);
        }

        $this->input = $input;
        $this->scoreDetails = $scoreDetails;
        if (is_array($combination)) {
            $combination = new ScoreFusionCombination(...$combination);
        }
