...
trait FactoryTrait
{
     ...
     */
    public static function documents(PackedArray|ResolvesToArray|BSONArray|array|string $documents): DocumentsStage
    {
    ...
    public static function geoNear(
        ...
        return new GeoNearStage($near, $distanceField, $distanceMultiplier, $includeLocs, $key, $maxDistance, $minDistance, $query, $spherical);
    }
    ...
    public static function replaceRoot(
        Document|Serializable|ResolvesToObject|stdClass|array|string $newRoot,
    ): ReplaceRootStage {
    ...
    public static function replaceWith(
        Document|Serializable|ResolvesToObject|stdClass|array|string $expression,
    ): ReplaceWithStage {
    ...
    public static function setWindowFields(
        ...
        Document|Serializable|stdClass|array $output,
        Optional|DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|string|null $partitionBy = Optional::Undefined,
